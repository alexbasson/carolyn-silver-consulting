...
export const AboutPage = () => (
  <div>
    ...
    <p>Trained as an attorney, Carolyn developed and expanded Lenox Hill Neighborhood House’s Civil Legal Services
      program, as Director of Legal Advocacy for more than eight years. She has been a steady leader throughout New York
      City’s legal services community for more than a decade. Carolyn was awarded the Felix Fishman award for
