...
export const AboutPage = () => (
  <div>
    <p>Carolyn Silver has dedicated her entire career to the pursuit of social justice, and has a multitude of
      ...
      myriad partners to ensure the highest quality of program operations. Throughout her leadership tenure, she created
      and implemented new areas of client-centered programming; ensured compliance with administrative and regulatory
      requirements; and engaged in fundraising activities with government and private philanthropy. She spearheaded
      Lenox Hill’s organizational efforts to improve outcome measurement and program evaluation, including facilitation
      of multiple new online case management systems, systemic data collection and dashboard creation, implementation of
      appropriate programmatic benchmarks, and the creation of programmatic needs assessments and ongoing program
      surveys.</p>
    ...
    <p>Trained as an attorney, Carolyn developed and expanded Lenox Hill Neighborhood House’s Civil Legal Services
      ...
      Outstanding Advocacy on behalf of New York’s underserved communities in 2012 by New York Lawyers for the Public
      Interest (NYLPI) and was a Harvard Law School Wasserstein Fellow in 2013. From 2017&ndash;2019, she served as the
      Co-President of the Board of the New York State Legal Services Coalition, and was a founding member of LEAP, a New
      York City coalition of legal services providers.</p>
    ...
    <p>Before joining the Neighborhood House in 2005, Carolyn clerked for the Honorable Andre M. Davis in the United
      ...
      expand the housing advocacy project at the AIDS Law Project of Pennsylvania, where she represented people living
      ...
      Ritz &amp; Clark LLP) a small civil rights law firm in New York City where she represented employees in employment
      discrimination matters.</p>
