  ...
  <div className="AboutPage">
    ...
    <div className="right">
      <p>Carolyn Silver has dedicated her entire career to the pursuit of social justice, and has a multitude of
        ...
        mentoring staff, providing strategic vision and programmatic oversight, and working collaboratively with myriad
        partners to ensure the highest quality of program operations. Throughout her leadership tenure, she created and
