  ...
  <div className="HomePage">
    ...
    <div className="content">
      <section>
        ...
        <div className="right">
          <p><strong>Carolyn Silver Consulting</strong> provides consulting services to non-profit organizations who are
            seeking to
            improve their programmatic operations and efficiency; enhance their impact; and take the next step toward
            operational excellence. With a particular focus on legal services and human services organizations, Carolyn
